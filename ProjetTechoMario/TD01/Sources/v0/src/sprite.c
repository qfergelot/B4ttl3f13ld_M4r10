...
void sprite_init (SDL_Renderer *ren, char *background_skin){
    ...
    sprite_create(ren, &missile_sprite, "../images/missiled.png", 64, 64, 12, RIGHT);
    sprite_create(ren, &explosion_sprite, "../images/explosion.png", 64, 64, 25, RIGHT);
    sprite_create(ren, &text_ouch_sprite, "../images/ouch.png", 512, 341, 1, RIGHT);
